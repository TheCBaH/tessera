...
| `uutf`, `uuseg`, `uucp` | Incremental UTF-8, Unicode segmentation, and properties. | Required portable building blocks.  Pin releases whose Unicode data matches the declared 15.1 policy, and test all three OCaml backends. |
